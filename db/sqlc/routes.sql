...
insert into routes (route_id, stop_position_id, from_station, to_station, via, ref, name, operator, network, service, country_iso_code) 
  ...
  on conflict (route_id, stop_position_id) do update set from_station = $3, to_station = $4, via = $5, ref = $6, name = $7, operator = $8, network = $9, service = $10, updated_at = CURRENT_TIMESTAMP, country_iso_code = $11
  returning *;
