...
insert into stop_positions (id, station_id, platform, coordinate, neighbors) 
  values ($1, $2, $3, $4, $5) 
...
-- name: CountStopPositionsWithoutStation :one
select count(*) from stop_positions where station_id is null;
